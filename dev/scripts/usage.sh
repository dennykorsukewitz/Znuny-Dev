...
show_usage() {
    ...
    print_command "random-data-insert <framework> [options]"   "RandomDataInsert; --help runs znuny.Console.pl Dev::Tools::Database::RandomDataInsert --help; else config / CLI options"
...
show_usage_examples() {
    ...
    print_command "$ZD_CMD random-data-insert dev --help" ""
